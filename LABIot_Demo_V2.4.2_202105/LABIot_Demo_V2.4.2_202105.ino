...
void loop() {
  ...
  char *p; 
  //uint8_t numberOfTags = sizeof(hexArr)/20;
  //Serial.println((String)"Number of Tags: " + numberOfTags);
  p = getTagfromHEX(hexArr, numberOfTags1);
...
//    Serial.println(numberOfTags1);
//    Serial.println((String)"String2: " + aString2);
//    Serial.println((String)"String1: " + aString1);
  }
  Serial.println((String)"Nomber of Tags: " + numberOfTags1);
  Serial.println((String)"String1: " + aString1);
  ...
  delay(100);
  String timestamp = "1";
  String data = buildData(aString1, timestamp, weight, unitinfo);
...
//  uhf.write(readMulti, sizeof(readMulti));
